                            ...
                            */
                            ...
                            // Data received
                                ...
                                if(strncmp(rx_buffer, "*SS:", 4) == 0){
                                    sscanf(rx_buffer, "*SS:%s:%s:%[^#]",userName,dateTime, buf);
                                ...
                                // totPolarity
                                        ...
                                        sscanf(rx_buffer, "*INH:%s:%s:%d#",userName,dateTime, &INHOutputValue);
                                        if (INHOutputValue != 0)
                                        {
                                            INHOutputValue = 1;
                                            gpio_set_level(CINHO, 0);
                                        ...
                                        sscanf(rx_buffer, "*SP:%s:%s:%d#",userName,dateTime, &jumperPort);
                                        ...
                                        sscanf(rx_buffer, "*CA:%s:%s:%d:%d#",userName,dateTime, &numValue,&polarity);
                                ...
                                tx_event_pending = 1;
                                    ...
                                    int ip_octet[4];
                                    int sp_port;
                                    sscanf(rx_buffer, "*SIP:%s:%s:%d.%d.%d.%d:%d#",userName,dateTime, &ip_octet[0],
                                        &ip_octet[1],
                                        &ip_octet[2],
                                        &ip_octet[3],
                                        &sp_port);
...
//                                  next time , add again to previous counts
                                    ...
                                    if (edges == 0)
                                    {
                                        sscanf(rx_buffer, "*SL:%s:%s:%d:%d#",userName,dateTime, &ledpin,&ledstatus);
                                        // strcpy(WIFI_PASS_2, buf);
                                        // utils_nvs_set_str(NVS_PASS_2_KEY, WIFI_PASS_2);
...
void process_uart_packet(const char *pkt){
    ...
    if(strncmp(pkt, "*SS:", 4) == 0){
        sscanf(pkt, "*SS:%s:%s:%[^#]",userName,dateTime, buf);
        ...
        int ip_octet[4];
        int sp_port;
        sscanf(pkt, "*SIP:%s:%s:%d.%d.%d.%d:%d#",userName,dateTime, &ip_octet[0],
            &ip_octet[1],
            &ip_octet[2],
            &ip_octet[3],
            &sp_port);
